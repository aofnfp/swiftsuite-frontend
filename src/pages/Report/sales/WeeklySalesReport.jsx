  ...
  return (
    <div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {[
          { label: "Total Sales", value: "$23", icon: <ShoppingBag className="text-green-600 mt-2" size={50}  /> },
          { label: "Total Sold Products", value: "100", icon: <Package className="text-green-600 mt-2" size={50}  /> },
          { label: "Total Dropshipping Cost", value: "$6.73", icon: <TrendingUp className="text-green-600 mt-2" size={50} /> },
        ].map((item, i) => (
         <div
            key={i}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {[1, 2, 3].map((item) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs sm:text-sm text-gray-500">$506</div>
                </div>
        ...
        <div className="bg-white p-4 sm:p-6 rounded-lg border border-gray-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              { label: "Products Listed", value: 20, color: "bg-gray-700" },
              { label: "Product Sold", value: 10, color: "bg-green-700" },
              { label: "Product Unsold", value: 140, color: "bg-yellow-600" },
            ].map((stat, index) => (
              <div
                key={index}
