...
const Zanders = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const rawFormData = {
      ...
      adult_sig_threshold: thresholdValue,
    };
      ...
      <section className="mb-10">
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="bg-white py-10">
            ...
            <div className="grid grid-cols-12 mt-8 h-10 px-5 items-center">
            ...
            <div className="px-5 mt-8">
              <h1 className="lg:text-xl font-bold">Manufacturer</h1>
              <div className="grid grid-cols-12 mt-5">
                <label className="mt-2 text-sm font-semibold col-span-5 md:col-span-6">
                  Select Manufacturer:
                </label>
                <div
                  className="relative border border-gray-500 rounded p-1 text-sm h-9 col-span-7 md:col-span-6 lg:w-3/4"
