...
import WeeklyInventoryChart from "./WeeklyInventoryChart";
          ...
          <div>
            ...
            <div className="flex flex-col gap-5 overflow-x-auto">
              ...
              <div className="min-w-[800px] flex bg-white items-center py-4 sm:py-6 rounded-[8px] text-[#005D68] text-sm sm:text-lg justify-center">
                ...
                <p className="basis-[10%] text-left px-2">22623</p>
                <p className="basis-[10%] text-center px-2">320</p>
                <p className="basis-[10%] text-center px-2">2431</p>
                <p className="basis-[10%] text-center px-2">$323</p>
                <p className="basis-[10%] text-right px-2">$44353</p>
              </div>
              <div className="min-w-[800px] flex bg-white items-center py-4 sm:py-6 rounded-[8px] text-[#005D68] text-sm sm:text-lg justify-center">
                ...
                <p className="basis-[10%] text-left px-2">45003</p>
                <p className="basis-[10%] text-center px-2">200</p>
                <p className="basis-[10%] text-center px-2">221</p>
                <p className="basis-[10%] text-center px-2">$20</p>
...
export default WeeklyInventoryReport;
