  ...
  return (
    <>
      <div className="flex items-center justify-center  h-[85vh]" >
        <section className='shadow-xl lg:w-1/3 md:w-[400px] w-full lg:p-6 p-4' >
          <div className=''>
            ...
            <form action="" className='' onSubmit={formik.handleSubmit}>
              ...
              <button type='submit' className='w-full bg-[#089451] flex justify-center items-center text-white font-bold py-3 mt-5 h-10'>{myLoader ? <img src={gif} alt="" className='w-[25px] ' /> : 'Reset Password'}</button>
            </form>
          </div>
        </section>
      </div>
